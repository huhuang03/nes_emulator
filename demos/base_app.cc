...
void BaseApp::drawCpu(int x, int y) {
    ...
    DrawString(x + 64, y, "N", getFlagColor(th::CPU::N));
    DrawString(x + 80, y, "V", getFlagColor(th::CPU::V));
    DrawString(x + 96, y, "-", getFlagColor(th::CPU::U));
    DrawString(x + 112, y, "B", getFlagColor(th::CPU::B));
    DrawString(x + 128, y, "D", getFlagColor(th::CPU::D));
    DrawString(x + 144, y, "I", getFlagColor(th::CPU::I));
    DrawString(x + 160, y, "Z", getFlagColor(th::CPU::Z));
    DrawString(x + 178, y, "C", getFlagColor(th::CPU::C));
...
olc::Pixel BaseApp::getFlagColor(th::CPU::FLAGS flag) {
